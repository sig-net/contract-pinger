...
exports.buildSignBidirectionalInstruction = void 0;
 ...
 */
const NO_CALLBACK_PROGRAM = web3_js_1.PublicKey.default;
/**
...
const buildSignBidirectionalInstruction = async ({ chainSigContract, requester, feePayer, args, }) => {
    ...
    return (program.methods
        .signBidirectional(args.serializedTransaction, args.caip2Id, args.keyVersion, args.path, args.algo, args.dest, args.params, NO_CALLBACK_PROGRAM, args.outputDeserializationSchema, args.respondSerializationSchema)
