...
const initNear = async ({ contractAddress }) => {
    ...
    const chainSigContract = new signetJs.chains.near.ChainSignatureContract({ networkId: nearNetworkId, contractId: contractAddress, accountId: nearAccount, keypair: keyPair });
...
const initNearNew = async ({ contractAddress, environment }) => {
    ...
    const chainSigContract = new signetJs.chains.near.ChainSignatureContract({ networkId: config.nearNetworkId, contractId: contractAddress, accountId: config.nearAccount, keypair: keyPair });
    return { connection, account, keyPair, chainSigContract };
};
